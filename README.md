...
#### This playbook was tested on Debian 8
...
2. Add Ansible with `sudo pip install ansible`
3. Update Apt with `sudo apt-get update && sudo apt-get upgrade`
4. Install Git `sudo apt-get install git`
5. Clone this repository with `git clone https://github.com/paulotfilho/hgv-deploy-full/`
